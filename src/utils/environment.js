...
export function odoo_builder(url, database) {
  return {
    login: (login, password) => {
      return _odoo_utils.odoo_authenticate(
    ...
    logout: () => {
      return _odoo_utils.odoo_logout(url + '/web/session/destroy');
    },
    graphql: _odoo_utils.graphqlbuilder(url + '/graphql'),
    session: () => {
      return _odoo_utils.odoo_session(url + '/web/session/get_session_info');
    },
  };
}
